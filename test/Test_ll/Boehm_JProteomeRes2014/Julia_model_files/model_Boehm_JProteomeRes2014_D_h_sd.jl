...
function compute_∂h∂u!(u, t::Real, pODEProblem::AbstractVector, θ_observable::AbstractVector,                    
	...
	if observableId == :pSTAT5B_rel 
		out[5] = ((pODEProblem[6] - 1)*(100u[6] + 200u[8] - 200u[8]*pODEProblem[6])) / ((u[5]*pODEProblem[6] + 2u[8]*pODEProblem[6] - u[5] - u[6] - 2u[8])^2)
	...
	if observableId == :rSTAT5A_rel 
		...
		out[8] = ((2pODEProblem[6] - 2)*(100u[6] + 100u[1]*pODEProblem[6] + 200u[2]*pODEProblem[6])) / ((u[5] + 2u[6] + 2u[8] + u[1]*pODEProblem[6] + 2u[2]*pODEProblem[6] - u[5]*pODEProblem[6] - 2u[8]*pODEProblem[6])^2)
		return nothing
	end
