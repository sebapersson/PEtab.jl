...
function compute_∂h∂u!(u, t::Real, pODEProblem::AbstractVector, θ_observable::AbstractVector,                    
	...
	if observableId == :observable_Insulin 
		...
		out[7] = (observableParameter2_observable_Insulin*observableParameter3_observable_Insulin*(observableParameter4_observable_Insulin^2)*(((u[10] + observableParameter4_observable_Insulin + u[7]*observableParameter3_observable_Insulin) / observableParameter4_observable_Insulin)^2) - observableParameter2_observable_Insulin*observableParameter3_observable_Insulin*(u[10]^2) - observableParameter2_observable_Insulin*(u[7]^2)*(observableParameter3_observable_Insulin^3) - 2u[10]*u[7]*observableParameter2_observable_Insulin*(observableParameter3_observable_Insulin^2) - u[10]*observableParameter2_observable_Insulin*observableParameter3_observable_Insulin*observableParameter4_observable_Insulin - u[7]*observableParameter2_observable_Insulin*observableParameter4_observable_Insulin*(observableParameter3_observable_Insulin^2)) / (observableParameter4_observable_Insulin*(u[10] + observableParameter4_observable_Insulin + u[7]*observableParameter3_observable_Insulin)*(((u[10] + observableParameter4_observable_Insulin + u[7]*observableParameter3_observable_Insulin) / observableParameter4_observable_Insulin)^2))
		out[10] = (observableParameter2_observable_Insulin*(observableParameter4_observable_Insulin^2)*(((u[10] + observableParameter4_observable_Insulin + u[7]*observableParameter3_observable_Insulin) / observableParameter4_observable_Insulin)^2) - observableParameter2_observable_Insulin*(u[10]^2) - u[10]*observableParameter2_observable_Insulin*observableParameter4_observable_Insulin - observableParameter2_observable_Insulin*(u[7]^2)*(observableParameter3_observable_Insulin^2) - 2u[10]*u[7]*observableParameter2_observable_Insulin*observableParameter3_observable_Insulin - u[7]*observableParameter2_observable_Insulin*observableParameter3_observable_Insulin*observableParameter4_observable_Insulin) / (observableParameter4_observable_Insulin*(u[10] + observableParameter4_observable_Insulin + u[7]*observableParameter3_observable_Insulin)*(((u[10] + observableParameter4_observable_Insulin + u[7]*observableParameter3_observable_Insulin) / observableParameter4_observable_Insulin)^2))
		return nothing
	end
