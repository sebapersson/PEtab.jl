#=
    Test 0015 from the PEtab test-suite recreated in Julia
=#
...
@test nll_rn ≈ 5.06071208119597 atol = 1.0e-3
@test nll_sys ≈ 5.06071208119597 atol = 1.0e-3
