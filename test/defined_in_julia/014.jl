...
observables = PEtabObservable(:obs_a, A, noiseParameter1_obs_a + noiseParameter2_obs_a)
...
@test nll_rn ≈ 3.68629528983135 atol = 1.0e-3
@test nll_sys ≈ 3.68629528983135 atol = 1.0e-3
