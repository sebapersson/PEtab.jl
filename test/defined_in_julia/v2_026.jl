...
simulation_conditions = PEtabCondition(
    :e1,
    :a0 => "initial_A1 + initial_A2",
    :b0 => initial_B1 / initial_B2
)
...
@test nll_rn ≈ 38.41336983161109 atol = 1.0e-3
@test nll_sys ≈ 38.41336983161109 atol = 1.0e-3
