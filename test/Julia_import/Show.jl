...
@variables t, A(t)
@test @sprintf("%s", PEtabParameter(:a0, value=1.0, scale=:lin, prior=Normal(0.0, 1.0))) == "PEtabParameter a0. Estimated on lin-scale with bounds [1.0e-03, 1.0e+03] and prior Normal{Float64}(μ=0.0, σ=1.0)"
