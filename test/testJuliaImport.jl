...
@testset "Log likelihood values and gradients for benchmark collection" begin
    ...
    pathJuliaFile = joinpath(@__DIR__, "JuliaImport", "Brannmark", "Julia_model_files", "Brannmark.jl")
    petabModel = readPEtabModel(pathYML, verbose=false, jlFile=true, jlFilePath=pathJuliaFile)
    ...
    pathJuliaFile = joinpath(@__DIR__, "JuliaImport", "Fujita", "Julia_model_files", "Fujita.jl")
    petabModel = readPEtabModel(pathYML, verbose=false, jlFile=true, jlFilePath=pathJuliaFile)
    ...
    pathJuliaFile = joinpath(@__DIR__, "JuliaImport", "Isensee", "Julia_model_files", "Isensee.jl")
    petabModel = readPEtabModel(pathYML, verbose=false, jlFile=true, jlFilePath=pathJuliaFile)
    ...
    pathJuliaFile = joinpath(@__DIR__, "JuliaImport", "Weber", "Julia_model_files", "Weber.jl")
    petabModel = readPEtabModel(pathYML, verbose=false, jlFile=true, jlFilePath=pathJuliaFile)
