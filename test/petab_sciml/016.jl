...
nnmodels = Dict(:net1 => NNModel(nn16; static = false))
...
PEtab.set_ps_net!(pnn, path_h5, nn16)

function _lv16!(du, u, p, t, nnmodels)
    prey, predator = u
...
lv16! = let _nnmodels = nnmodels
    (du, u, p, t) -> _lv16!(du, u, p, t, _nnmodels)
end
