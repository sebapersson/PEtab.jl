...
nnmodels = Dict(:net1 => NNModel(nn26_frozen; st = st, static = false))

function _lv26!(du, u, p, t, nnmodels)
    prey, predator = u
...
lv26! = let _nnmodels = nnmodels
    (du, u, p, t) -> _lv26!(du, u, p, t, _nnmodels)
end
