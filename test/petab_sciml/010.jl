...
nnmodels = Dict(:net1 => NNModel(nn10_1; static = false),
                :net2 => NNModel(nn10_2; static = false))
...
PEtab.set_ps_net!(pnn1, path_h5, nn10_1)
...
PEtab.set_ps_net!(pnn2, path_h5, nn10_2)

function _lv10!(du, u, p, t, nnmodels)
    prey, predator = u
    ...
    net2 = nnmodels[:net2]
    du2_nn, st = net2.nn([prey, predator], p[:net2], net2.st)
    net2.st = st
...
lv10! = let _nnmodels = nnmodels
    (du, u, p, t) -> _lv10!(du, u, p, t, _nnmodels)
end
