const MEASUREMENT_COLS = Dict("observableId" => (required = true, types = AbstractString),
                              ...
                              "preequilibrationConditionId" => (required = false, types = Union{AbstractString, Missing}),
                              "observableParameters" => (required = false, types = Union{AbstractString, Real, Missing}),
...
const PARAMETERS_COLS = Dict("parameterId" => (required = true, types = AbstractString),
                             ...
                             "initializationPriorParameters" => (required = false, types = Union{Missing, AbstractString}),
...
const OBSERVABLES_COLS = Dict("observableId" => (required = true, types = AbstractString),
                              ...
                              "observableTransformation" => (required = false, types = Union{AbstractString, Missing}),
