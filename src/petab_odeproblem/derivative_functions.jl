...
function _get_grad_forward_AD(probinfo::PEtabODEProblemInfo, model_info::ModelInfo)::Function
    @unpack split_over_conditions, gradient_method, chunksize = probinfo
    @unpack sensealg, cache = probinfo
    _nllh_not_solveode = _get_nllh_not_solveode(probinfo, model_info; grad_forward_AD = true)
    ...
    if split_over_conditions == false
        ...
        _grad! = let _nllh_not_solveode = _nllh_not_solveode, _nllh_solveode = _nllh_solveode, cfg = cfg, minfo = model_info, pinfo = probinfo
    ...
    if split_over_conditions == true
        _nllh_solveode = _get_nllh_solveode(probinfo, model_info; cid = true, grad_xdynamic = true)

        _grad! = let _nllh_not_solveode = _nllh_not_solveode, _nllh_solveode = _nllh_solveode, minfo = model_info, pinfo = probinfo
...
function _get_grad_forward_eqs(probinfo::PEtabODEProblemInfo, model_info::ModelInfo)::Function
    @unpack split_over_conditions, gradient_method, chunksize = probinfo
    @unpack sensealg, cache = probinfo
    ...
    _nllh_not_solveode = _get_nllh_not_solveode(probinfo, model_info; grad_forward_eqs = true)

    _grad! = let _nllh_not_solveode = _nllh_not_solveode, _solve_conditions! = _solve_conditions!, minfo = model_info, pinfo = probinfo, cfg = cfg
...
function _get_hess_forward_AD(probinfo::PEtabODEProblemInfo, model_info::ModelInfo)::Function
...
function _get_hess_block_forward_AD(probinfo::PEtabODEProblemInfo, model_info::ModelInfo)::Function
    @unpack split_over_conditions, chunksize = probinfo
...
function _get_hess_gaussnewton(probinfo::PEtabODEProblemInfo, model_info::ModelInfo, ret_jacobian::Bool)::Function
