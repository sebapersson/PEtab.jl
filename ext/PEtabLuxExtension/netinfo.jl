const PS_FREE_LAYERS = Union{
    Lux.MaxPool, Lux.MeanPool, Lux.LPPool, Lux.AdaptiveMaxPool, Lux.AdaptiveMeanPool,
...
const LAYERS = Dict(
    ...
    "Flatten" => (
        lux_layer = Lux.FlattenLayer,
        args = String[],
        kwargs = ["start_dim", "end_dim"],
    ),
    "MaxPool1d" => (
        lux_layer = Lux.MaxPool,
        args = ["kernel_size" => 1],
    ...
    "AdaptiveAvgPool1d" => (
        lux_layer = Lux.AdaptiveMeanPool,
        args = ["output_size" => 1],
        kwargs = String[],
    ...
    "Dropout" => (
        lux_layer = Lux.Dropout,
        args = ["p" => 1],
        kwargs = String[],
    ),
    "AlphaDropout" => (
        lux_layer = Lux.AlphaDropout,
        args = ["p" => 1],
        kwargs = String[],
    ),
    "Dropout1d" => (
