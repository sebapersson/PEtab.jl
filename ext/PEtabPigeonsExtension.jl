...
LogDensityProblemsAD.ADgradient(::Symbol, log_potential::PEtab.PEtabLogDensity, buffers::Pigeons.Augmentation) = Pigeons.BufferedAD(log_potential, buffers)

function LogDensityProblems.logdensity_and_gradient(logpotential::Pigeons.BufferedAD{<:PEtabLogDensity}, x)
...
function sample_iid!(state::AbstractVector, rng, inference_info::PEtab.InferenceInfo)::Nothing
...
function PEtab.to_chains(res::Pigeons.PT, target::PEtab.PEtabLogDensity; start_time=nothing, end_time=nothing)
    # Dependent on method
