function BeerOdeModel()
    ...
    EquationList = [
        ...
        Differential(t)(cGlu) ~ +1.0 * (1 / medium) *
                                (medium * (Bac * Glu * ksyn - (cGlu)^(2) * kdim)),
        Differential(t)(Ind) ~ +1.0 * (1 / medium) *
                               (medium * ((cGlu)^(2) * kdim - Ind * kdegi)),
        Differential(t)(Bac) ~ +1.0 * (1 / medium) *
                               (medium * (Bac * beta * lag * (Bacmax + -Bac) / Bacmax)),
