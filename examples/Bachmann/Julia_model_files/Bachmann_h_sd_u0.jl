...
function compute_h(u::AbstractVector, t::Real, p_ode_problem::AbstractVector, θ_observable::AbstractVector,
	...
	if observableId === :observable_SOCS3_au 
		...
		return observableParameter1_observable_SOCS3_au + u[14] * observableParameter2_observable_SOCS3_au / p_ode_problem[39] 
	end
	...
	if observableId === :observable_pEpoR_au 
		...
		return observableParameter1_observable_pEpoR_au + observableParameter2_observable_pEpoR_au * ( 16 * u[20] + 16 * u[1] + 16 * u[21] ) / p_ode_problem[34] 
	end
	...
	if observableId === :observable_pJAK2_au 
		...
		return observableParameter1_observable_pJAK2_au + observableParameter2_observable_pJAK2_au * ( 2 * u[23] + 2 * u[20] + 2 * u[1] + 2 * u[21] ) / p_ode_problem[34] 
	end
