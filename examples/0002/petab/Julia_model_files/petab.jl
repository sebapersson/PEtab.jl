function getODEModel_petab(foo)
    ...
    ### Derivatives ###
    eqs = [
        D(x1) ~ -1.0 * (1 / default) * (default * ((((k3) * (x1)) * (x2)) / (default))) +
                1.0 * (1 / default) * (default * ((k1) / (default))) -
                1.0 * (1 / default) * (default * (((k2) * (x1)) / (default))),
        D(observable_x2) ~ 0,
        D(sigma_x2) ~ 0,
        D(x2) ~ -1.0 * (1 / default) * (default * ((((k3) * (x1)) * (x2)) / (default))) +
                1.0 * (1 / default) * (default * (((k2) * (x1)) / (default))),
    ]
