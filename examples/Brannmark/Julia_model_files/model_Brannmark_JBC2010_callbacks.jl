function getCallbacks_model_Brannmark_JBC2010()
    cb_insulin_bool1 = DiscreteCallback(condition_insulin_bool1, affect_insulin_bool1!,
                                        save_positions = (false, false))

    cb_insulin_bool2 = DiscreteCallback(condition_insulin_bool2, affect_insulin_bool2!,
                                        save_positions = (false, false))

    return CallbackSet(cb_insulin_bool1, cb_insulin_bool2),
           [is_active_t0_insulin_bool1!, is_active_t0_insulin_bool2!]
end
