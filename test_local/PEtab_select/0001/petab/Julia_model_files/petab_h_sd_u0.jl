#u[1] = x1, u[2] = x2
#pODEProblemNames[1] = default, pODEProblemNames[2] = observable_x2, pODEProblemNames[3] = k3, pODEProblemNames[4] = sigma_x2, pODEProblemNames[5] = k1, pODEProblemNames[6] = k2
#
...
function compute_u0!(u0::AbstractVector, pODEProblem::AbstractVector) 
	...
	#pODEProblem[1] = default, pODEProblem[2] = observable_x2, pODEProblem[3] = k3, pODEProblem[4] = sigma_x2, pODEProblem[5] = k1, pODEProblem[6] = k2
...
function compute_σ(u::AbstractVector, t::Real, θ_sd::AbstractVector, pODEProblem::AbstractVector, θ_nonDynamic::AbstractVector,
	...
	if observableId === :obs_x2 
		noiseParameter1_obs_x2 = getObsOrSdParam(θ_sd, parameterMap)
